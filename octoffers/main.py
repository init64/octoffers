...
class Octoffers:
    ...
    def fetch_all_jobs_by_role(self, role="Data+Engineer", tools=None, min_salary=None, exclusion_words=['Junior', 'platform', 'Hydrographic']):
    ...
    def fetch_all_jobs_for_me(self, tools=['dbt', 'aws', 'python', 'pandas'], min_salary=None, exclusion_words=['Junior', 'platform', 'Hydrographic']):
